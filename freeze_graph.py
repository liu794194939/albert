...
if __name__ == '__main__':
    ...
    parser.add_argument('-bert_model_dir', type=str, default='/home/Sentence_Similarity/albert_zh/init_checkpoint',
                        help='chinese google bert model path')
    parser.add_argument('-model_dir', type=str, default='/home/Sentence_Similarity/albert_zh/output',
                        help='directory of a pretrained BERT model')
    parser.add_argument('-model_pb_dir', type=str, default='/home/Sentence_Similarity/albert_zh/output',

...
class BertSim:
    ...
    def predict_sentences(self,sentences):
        results= self.estimator.predict(input_fn=input_fn_builder(self,sentences), yield_single_examples=True)
        #打印预测结果
        for i in results:
            print(i)
...
if __name__ == '__main__':
    print('****************************************开始*******************************',time.time())
    sim = BertSim()
    print('****************************************加载模型*****************************************************',time.time())
    sim.start_model()
    print('*****************************************加载完毕****************************************************',time.time())
    start_time=time.time()
    sim.predict_sentences([("我喜欢妈妈做的汤", "妈妈做的汤我很喜欢")])
    sim.predict_sentences([("我喜欢妈妈做的汤", "妈妈做的汤我很不喜欢")])
    print('###########################################预测耗费时间##############################################',time.time()-start_time)

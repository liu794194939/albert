...
## Required parameters
flags.DEFINE_string(
    "data_dir", '/home/Sentence_Similarity/albert_zh/data',
    "The input data dir. Should contain the .tsv files (or other data files) "
    "for the task.")

flags.DEFINE_string(
    "bert_config_file", '/home/Sentence_Similarity/albert_zh/albert_config/albert_config_tiny.json',
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", 'lcqmc_pair', "The name of the task to train.")

flags.DEFINE_string("vocab_file", '/home/Sentence_Similarity/albert_zh/albert_config/vocab.txt',
                    "The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string(
    "output_dir", '/home/Sentence_Similarity/albert_zh/output',
    "The output directory where the model checkpoints will be written.")

## Other parameters

flags.DEFINE_string(
    "init_checkpoint", '/home/Sentence_Similarity/albert_zh/init_checkpoint',
